...
export const Features = () => {
  return (
    <>
      <section id="features" className="py-xl px-6 bg-neutral/50 dark:bg-zinc-950 border-t border-outline dark:border-zinc-800 hidden md:block">
        <div className="max-w-7xl mx-auto">
          <div className="mb-xl flex flex-col gap-6 text-center md:text-left">
            <h2 className="text-4xl md:text-6xl font-black tracking-tighter text-secondary dark:text-zinc-50 font-display">The ultimate marketplace app.</h2>
            <p className="text-tertiary dark:text-zinc-400  text-xl md:text-2xl font-medium text-balance font-sans">Engineered from the ground up to empower buyers and sellers with modern tools.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-md auto-rows-[340px]">
            {/* Bento Box 1: Large Social Feature */}
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="md:col-span-2 group bg-white dark:bg-zinc-900 rounded-lg border border-outline dark:border-zinc-800 overflow-hidden relative flex flex-col justify-between hover:shadow-kinetic transition-all duration-300 min-h-85">
              ...
              <div className="relative z-10  p-md flex flex-col h-full justify-between">
                <div className="w-14 h-14 bg-white/20 backdrop-blur-md text-white rounded-DEFAULT flex items-center justify-center mb-8 border border-white/10 shadow-lg">
                  <Users size={28} />
                </div>
                <div>
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.1 }} className="group bg-white dark:bg-zinc-900 rounded-lg border border-outline dark:border-zinc-800 overflow-hidden relative flex flex-col justify-between p-md hover:shadow-kinetic transition-all duration-300 min-h-[340px]">
              <div className="relative z-10">
                <div className="w-14 h-14 bg-neutral dark:bg-zinc-800 text-secondary dark:text-zinc-50 rounded-DEFAULT flex items-center justify-center mb-8 group-hover:scale-110 transition-transform">
                  <ShieldCheck size={28} />
                </div>
                <h3 className="text-2xl font-bold mb-4 text-secondary dark:text-zinc-50 font-display tracking-tight">Total Safety</h3>
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.2 }} className="group bg-white dark:bg-zinc-900 rounded-lg border border-outline dark:border-zinc-800 overflow-hidden relative flex flex-col justify-between hover:shadow-kinetic transition-all duration-300 min-h-[340px]">
              ...
              <div className="relative z-10 p-md flex flex-col h-full justify-between">
                <div className="w-14 h-14 bg-white dark:bg-zinc-800 text-secondary dark:text-zinc-50 rounded-DEFAULT flex items-center justify-center mb-8 shadow-sm group-hover:scale-110 transition-transform border border-outline dark:border-zinc-700">
                  <LayoutGrid size={28} />
                </div>
                <div>
                  <h3 className="text-2xl font-bold mb-4 text-secondary dark:text-zinc-50 font-display tracking-tight">Clean Interface</h3>
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.3 }} className="md:col-span-2 group bg-secondary dark:bg-zinc-900 text-white rounded-lg overflow-hidden relative flex flex-col justify-between p-md shadow-xl border border-zinc-800 dark:border-zinc-700 min-h-[340px]">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-secondary dark:from-zinc-900 via-secondary/80 dark:via-zinc-900/80 to-transparent pointer-events-none"></div>
      ...
      <section className="py-xl px-4 sm:px-6 bg-neutral dark:bg-zinc-950 border-t border-outline dark:border-zinc-800 md:hidden pb-0">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-black mb-4 tracking-tighter text-secondary dark:text-zinc-50 font-display">App Features</h2>
          <p className="text-lg sm:text-xl text-tertiary dark:text-zinc-400 font-sans">Built to empower.</p>
        </div>
        <div className="flex flex-col gap-6">
          <div className="bg-white dark:bg-zinc-900 rounded-lg p-8 shadow-sm border border-outline dark:border-zinc-800">
            <Users size={32} className="text-primary mb-6" />
            <h3 className="text-2xl font-bold mb-3 text-secondary dark:text-zinc-50 font-display">Authentic Connections</h3>
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-lg p-8 shadow-sm border border-outline dark:border-zinc-800">
            <ShieldCheck size={32} className="text-secondary dark:text-zinc-50 mb-6" />
            <h3 className="text-2xl font-bold mb-3 text-secondary dark:text-zinc-50 font-display">Total Safety</h3>
          ...
          <div className="bg-secondary dark:bg-zinc-100 text-white dark:text-secondary rounded-lg p-8 shadow-xl border border-transparent dark:border-zinc-800">
            <div className="inline-flex items-center gap-2 bg-primary text-white text-xs font-black uppercase tracking-widest px-3 py-1.5 rounded-md mb-6 shadow-md">
