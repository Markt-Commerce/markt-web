     ...
     return (
          <section className="py-xl px-4 sm:px-6">
               <div className="max-w-7xl mx-auto">
                    <div className="rounded-2xl overflow-hidden bg-white/80 dark:bg-zinc-950/70 shadow-kinetic backdrop-blur-sm">
                         {/* Desktop three-column layout */}
                         <div className="hidden lg:grid lg:grid-cols-[0.9fr_1.1fr_1.1fr]">
                              {/* Labels column */}
                              <div className="bg-neutral/50 dark:bg-zinc-900/70">
                                   <div className="px-6 py-6">
                                        <h3 className="text-lg font-bold font-display text-secondary dark:text-white">What Matters</h3>
                                   </div>
                              ...
                              {/* Competitors column */}
                              <div className="bg-neutral/20 dark:bg-zinc-900/50">
                                   <div className="px-6 py-6 flex items-center gap-4">
                                        <h3 className="text-lg font-bold font-display text-secondary dark:text-white">Traditional Marketplaces</h3>
                                   </div>
                                   <div className="divide-y divide-black/5 dark:divide-white/5">
                                        {rows.map((r) => (
                                             <div key={r.label} className="px-6 py-5 text-sm text-tertiary dark:text-zinc-400">
                                   ...
                                   <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-6">
                                        <div className="flex items-center gap-3 min-w-0">
                                             ...
                                             <div className="min-w-0">
                                                  <div className="text-sm font-black font-display text-secondary dark:text-white">Markt</div>
                                                  <div className="text-xs text-tertiary dark:text-zinc-400">Social commerce</div>
                                             </div>
                                        </div>
                                        <div className="text-sm font-bold text-secondary dark:text-white">Traditional Marketplaces</div>
                                   </div>

                                   <div className="space-y-3">
                                        {rows.map((r) => (
                                             <div key={r.label} className="rounded-xl bg-white dark:bg-zinc-900/80 p-4 sm:p-5 shadow-sm">
                                                  ...
                                                  <div className="grid gap-3 sm:grid-cols-2">
                                                       ...
                                                       <div className="rounded-lg bg-neutral/70 dark:bg-zinc-800/80 px-4 py-3 text-sm text-secondary dark:text-zinc-300">
                                                            {r.right}
                                                       </div>
                                                  </div>
                                             </div>
