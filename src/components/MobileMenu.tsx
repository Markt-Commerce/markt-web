    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          <motion.div
            className="hidden left-0 top-0 lg:block absolute w-8 h-8 rounded-full bg-brand mix-blend-screen pointer-events-none z-50 blur-sm"
          ...
          <button
            onClick={onClose}
            className="absolute top-6 right-6 sm:top-10 sm:right-10 w-12 h-12 sm:w-16 sm:h-16 flex items-center justify-center rounded-full bg-zinc-900 text-primary hover:bg-zinc-800 transition-colors z-50 shadow-xl border border-white/10"
          >
          ...
          <div className="flex flex-col gap-6 text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black items-center text-center z-10 w-full px-6 font-display">
            {menuLinks.map((link, i) => (
              ...
              >
                <button
                  ...
                  className="relative z-10 hover:text-primary transition-colors duration-500 py-4 flex items-center justify-center gap-6 w-full tracking-tighter"
                >
            ...
            <motion.button
              ...
              className="bg-primary text-white transition-all duration-300 px-12 py-6 rounded-DEFAULT mt-10 text-2xl font-black shadow-kinetic relative font-display tracking-tighter hover:-translate-y-1"
