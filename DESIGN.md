...
## Shapes
The shape language is "Structured Softness." By using a consistent 8px-12px radius, the UI feels approachable and human without appearing juvenile or "bubbly."

- **Standard Elements (Buttons, Inputs):** Use the 8px (0.5rem) base radius.
- **Large Elements (Cards, Modals):** Use the 16px (1rem) `rounded-lg` radius to frame images elegantly.
- **Avatars:** Strictly circular to emphasize the human connection in social e-commerce.
...
- **Cards:** Cards are border-heavy with no default shadow. They rely on the `rounded-lg` radius. The product image always occupies the top 70% of the card area.
